...
class AdditionalDBVPM_Spec extends Specification {
   ...
   def 'test condition type' () {
      caseName = specificationContext.currentIteration.name
      additionalConnectionTest = new AdditionalConnectionTest(caseName)
      additionalConnectionTest.executeTest('1^128^__NULL__^MultiTenantVPM/TestcaseVS-VPM_M2_C2', [admin] as String[], null)
   ...
   def 'test get extended partition2' () {
      caseName = specificationContext.currentIteration.name
      additionalConnectionTest = new AdditionalConnectionTest(caseName)
      additionalConnectionTest.executeTest('1^128^__NULL__^MultiTenantVPM/TestcaseVS-VPM_M3_C4', [user0] as String[], null)
