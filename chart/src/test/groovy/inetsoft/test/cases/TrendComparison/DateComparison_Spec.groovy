...
class DateComparison_Spec extends Specification{
   ...
   /*check period is year and interval is quarteré”?chart covered highlight & format & bookmark1 covered target band & project forward*/
   def 'Year_Quarter'() {
   ...
   chart include highlight & format & axis properties testé”?bookmark include project forward & target line & fillseries as zero test*/
   def 'Same Level'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?granularity is year/quarter, bk1 check target line for runtime col*/
   def 'Custom_normal1'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is month/week */
   def 'Custom_normal2'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is day */
   def 'Custom_normal3'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is All */
   ...
   /*check custom periodé”?interval is quarter to date for each year/quarter */
   @Ignore
   def 'Custom_xtodate3'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is month to date for each year/quarter */
   @Ignore
   def 'Custom_xtodate4'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is month to date for each month */
   @Ignore
   def 'Custom_xtodate5'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is week to date for each year/quarter */
   @Ignore
   def 'Custom_xtodate6'() {
      caseName = specificationContext.currentIteration.name
   ...
   /*check custom periodé”?interval is week to date for each month/week */
   @Ignore
   def 'Custom_xtodate7'() {
      caseName = specificationContext.currentIteration.name
